...
// JOHN
public Product(String name,int UPC,double price,String PU,boolean sale,double salePercent ,double quantity, double purchasePrice)
{
	this.name=name;
	this.UPC=UPC;
	this.price=price;
...
public void setPricefromReturn(double newPrice)
{
		this.price=newPrice;
...
public void setQuantity(double quantity)
{
	...
	setPurchasePrice();
	System.out.println("Done Set Price");
}
