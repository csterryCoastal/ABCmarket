...
public class StoreFacade {
	...
	public Item[] getInventory() throws NamingException,SQLException,ClassNotFoundException
	{
		...
		Item[] Inventory = new Item[10000];// Using 10k+1 to represent items 1-9999
		...
		while (rs.next()) {
			...
			Item holder =new Item(name,UPC,price,PU,sale,onSale);
